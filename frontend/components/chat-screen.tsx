...
export function ChatScreen({ locale }: { locale: string }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col lg:mx-auto lg:w-full lg:max-w-[780px]">
      <div className="flex items-center gap-2.5 border-b border-border px-6 py-4 lg:px-0 lg:pt-4 lg:pb-4">
      ...
      <div ref={scrollContainerRef} data-testid="chat-scroll-container" onScroll={handleScroll} className="scrollbar-none flex-1 overflow-y-auto px-5 py-4 lg:px-0 lg:py-5">
      ...
      <div className="flex items-center gap-2.5 border-t border-border px-4 py-3 lg:px-0 lg:pt-4 lg:pb-7">
        <Input
          ...
          className="h-11 rounded-full border-border bg-card px-5 text-primary placeholder:text-muted-light lg:h-12"
